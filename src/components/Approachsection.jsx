...
const ApproachSection = () => {
  return (
    <section id="approach" className="py-24 px-6 md:px-16 bg-background text-foreground">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-10">
          ...
          <div className="bg-white p-8 rounded-2xl shadow hover:shadow-lg transition">
            <FaTshirt className="text-primary text-4xl mb-4 mx-auto" />
          ...
          {/* Cleaner & Greener */}
          <div className="bg-white p-8 rounded-2xl shadow hover:shadow-lg transition">
            <FaLeaf className="text-secondary text-4xl mb-4 mx-auto" />
