...
const Footer = () => {
  return (
    <footer className="bg-foreground text-gray-200 py-8">
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row gap-2" onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              className="p-3 rounded-md flex-1 text-primary focus:outline-none w-full sm:w-auto"
              required
            />
            <button
              type="submit"
              className="bg-primary text-primary-foreground px-6 py-3 rounded-md hover:bg-primary/90 transition w-full sm:w-auto"
            > Subscribe
            </button>
          </form>
        </div>
